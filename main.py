...
DEFAULT_SEARCH_MARKUP = [
                    ...
                    [InlineKeyboardButton("Deployed: @ProjectNetflixLK", url="https://t.me/ProjectNetflixlK")]
                ]
...
async def start_handler(_, message: Message):
    try:
        await message.reply_text(
            text="Hello, I am NFLK Torrage Bot!\n"
                 "I can search Torrent Magnetic Links from Inline.\n\n"
                 "Deployed by @ProjectNetflixLK",
